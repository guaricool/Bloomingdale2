            ...
            <div className="flex min-h-screen flex-col">
              ...
              <footer className="mt-16 border-t border-slate-200 bg-slate-50/60">
                <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-3 px-6 py-8 sm:flex-row">
                  ...
                  <p className="font-display text-xs italic text-slate-400">
...
function PublicHeader() {
  return (
    <header className="sticky top-0 z-40 w-full border-b border-slate-200/60 bg-slate-50/85 backdrop-blur-md">
