    ...
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <div className="paper-card flex flex-col items-center p-8 text-center">
          <h2 className="mb-2 font-display text-2xl font-medium text-ink-900">
            Plataforma Completa
          </h2>
          <p className="mb-6 font-sans text-sm text-ink-500">
            Abre la página principal de la rama con todos los recursos y anuncios.
          </p>
          <div className="rounded-2xl border-4 border-sage-100 bg-white p-4 shadow-sm">
            <QRCodeSVG value={urlHome} size={220} level="M" includeMargin={false} />
          </div>
          <div className="mt-6 w-full rounded-md bg-cream-50 px-3 py-2 font-mono text-xs text-ink-600 break-all border border-cream-200">
            {urlHome}
          </div>
        </div>
