  ...
  return (
    <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-10">
      <div className="reveal space-y-3">
        ...
        <h1 className="font-display text-4xl font-medium tracking-tight text-charcoal-900 sm:text-5xl">
          {displayName}
        </h1>
        <p className="max-w-2xl font-display text-base italic text-charcoal-500">
          {todayNote}
        </p>
      </div>
      ...
      <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card interactive>
          <CardBody>
            ...
            <p className="mt-3 font-display text-5xl font-medium text-charcoal-900">
              {memberCount}
            </p>
            <p className="text-sm text-charcoal-500">miembros en la rama</p>
        ...
        <Card interactive>
          <CardBody>
            ...
            <p className="text-sm text-charcoal-500">eventos en el calendario</p>
            <div className="mt-5">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <Card interactive>
              <CardBody>
                ...
                <p className="mt-2 font-display text-lg text-charcoal-900">Directorio y grupos</p>
                <p className="mt-1 text-sm text-charcoal-500">
            ...
            <Card interactive>
              <CardBody>
                ...
                <p className="mt-2 font-display text-lg text-charcoal-900">Dominicales</p>
                <p className="mt-1 text-sm text-charcoal-500">
            ...
            <Card interactive>
              <CardBody>
                ...
                <p className="mt-2 font-display text-lg text-charcoal-900">Calendario</p>
                <p className="mt-1 text-sm text-charcoal-500">
